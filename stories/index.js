...
storiesOf("Appointment", module)
  ...
  .add("Appointment wtih Time", () => <Appointment time="12pm" />)
  ...
  .add("Edit", () => <Form interviewer={1} interviewers={interviewers} student="Krista" onSave={action("onSave")} onCancel={action("onCancel")} />)
